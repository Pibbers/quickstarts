...
:tabs:
:page-image-directory: connect-looker
...
* Google Cloud service account (you can create free account),
...
image::{page-image-directory}/gcp-login.png[GCP Console, width=500]

Ensure the Teradata Vantage compute engine is up and running.

image::{page-image-directory}/gcp-verify-vantage.png[Ensure Vantage is running, width=500]
...
image::{page-image-directory}/looker-logon.png[Logon to Looker, width=500]

* Create a Database connection, which is located in Admin > Connections > Add Connection > Database Connection.

image::{page-image-directory}/create-connection.png[Connections, width=500]

image::{page-image-directory}/create-connection-2.png[Add connection, width=500]
...
image::{page-image-directory}/connection-settings.png[Connection settings, width=500]

* If you are using a character set besides the default, a parameter can be added in the Additional params section.

image::{page-image-directory}/connection-settings-2.png[Character set, width=500]

* Click on Test These Settings to verify connectivity.

image::{page-image-directory}/test-settings.png[Test connection settings, width=500]

=== Run a query in Google Looker
* Open SQL Runner in Looker, which is located under Develop > SQL Runner.

image::{page-image-directory}/sql-runner.png[Open SQL Runner, width=500]

* You can now run SQL queries in Vantage. Select a Connection and Schema (user or database).

image::{page-image-directory}/run-query.png[Run a query, width=500]
...
image::{page-image-directory}/results.png[Results, width=500]
